...
echo "0.0.0.0 dl.serverspeeder.com " >> /etc/hosts
echo "0.0.0.0 my.serverspeeder.com " >> /etc/hosts
echo "0.0.0.0 www.serverspeeder.com " >> /etc/hosts
echo "0.0.0.0 dl.lotserver.cn " >> /etc/hosts
echo "0.0.0.0 my.lotserver.cn " >> /etc/hosts
echo "0.0.0.0 www.lotserver.cn " >> /etc/hosts
